...
#+begin_src emacs-lisp
  ...
  ;; 키바인딩 설정
  (global-set-key (kbd "C-c C-l c") 'claude-vterm)
  (global-set-key (kbd "C-c C-l r") 'claude-send-region)
  (global-set-key (kbd "C-c C-l b") 'claude-send-buffer)
  (global-set-key (kbd "C-c C-l a") 'claude-ask)
  (global-set-key (kbd "C-c C-l p") 'claude-project)
#+end_src
